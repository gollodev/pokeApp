	...
	.constant('API', 
		{
		  ...
		  ,	nidoqueen: 	url + 'api/v1/pokemon/31/'	
		  ,	nidorino: 	url + 'api/v1/pokemon/33/'	
		  ,	nidoking: 	url + 'api/v1/pokemon/34/'	
		  ...
		  ,	magneton: 	url + 'api/v1/pokemon/82/'	
